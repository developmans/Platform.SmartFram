...
/**
 * @author Next
 * @version 1.0 E-mail: caiwl2005@126.com 创建时间：2015-9-15 下午6:48:39 类说明
 */
...
public final class SQLiteDataBaseConfig {
	...
	protected static final String TABLE_NAME_SOURCE_INFO = "SourceInfo";
	protected static final String TABLE_DDL_SOURCE_INFO = "CREATE TABLE SourceInfo ( "
			+ "ID            INTEGER     PRIMARY KEY AUTOINCREMENT NOT NULL,"
			+ "RFID_ID       VARCHAR(20) NOT NULL,"
			+ "VARIETIES     VARCHAR(10) NOT NULL DEFAULT ( '未知' ),"
			+ "REGION        INTEGER     NOT NULL DEFAULT ( 0 ),"
			+ "PLANTING_DATE DATETIME    NOT NULL DEFAULT ( ( datetime( 'now', 'localtime' )  )  ) ,"
			+ "HARVEST_DATE  DATETIME    NOT NULL DEFAULT ( ( datetime( 'now', 'localtime' )  )  ) )";
